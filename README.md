...
## Test build status
[![MATLAB](https://github.com/augustjohansson/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/augustjohansson/ci-configuration-examples/actions/workflows/ci.yml)
